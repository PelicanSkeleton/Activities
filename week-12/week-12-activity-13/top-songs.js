...
//     connection.query("SELECT * FROM topsongs WHERE topsongs.artist = 'Whitney Houston' ", function (error, results, fields) {
        ...
        .then(function (answer) {
            switch (answer.action) {
                ...
                case "Find all artists who appear more than once":
                    multiSearch();
                    break;
                case "Find all data within a specific range":
                    rangeSearch();
                    break;
...
function artistSearch() {
    inquirer
        ...
        .then(function (answer) {
            var query = "SELECT id, song, year FROM topsongs WHERE ?";
